...
data1$un_pi_gap <- data1$unrate + data1$infgap/33.99
#Note that 33.99 was the estimated coefficient of unemployment rate in model 3.
...
data5 <- na.omit(data4)
plot.xts(data5$unrate, col = "black", lwd = 3, main = "France NAIRU", main.timespan = FALSE, lty = 3, ylim = c(2, 14)) #unemployment rate
