...
ggplot() +
  geom_line(data = data_pc$LNS14024887, aes(x = Index, y = data_pc$LNS14024887, color = "16 to 24 years", linetype = "16 to 24 years"), lwd = 1) +
  geom_line(data = data_pc$LNS14000060, aes(x = Index, y = data_pc$LNS14000060, color = "24 to 54 years", linetype = "24 to 54 years"), lwd = 1) +
  geom_line(data = data_pc$LNS14024230, aes(x = Index, y = data_pc$LNS14024230, color = "55 years and older", linetype = "55 years and older"), lwd = 1) +
